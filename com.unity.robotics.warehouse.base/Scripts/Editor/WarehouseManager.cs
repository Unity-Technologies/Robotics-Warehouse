    ...
    public class WarehouseManager : MonoBehaviour
    {
        ...
        public GameObject ParentGenerated
        {
            get
            {
                ...
                {
                    var existingParent = GameObject.Find("GeneratedWarehouse");
                    m_ParentGenerated = existingParent != null ? existingParent : new GameObject(k_GeneratedWarehouseObjectName);
                }
        ...
        /// <summary>
        /// Grabs the root object of the prefab instance this prefab instance is in.
        /// </summary>
        /// <param name="obj">Transform of the child prefab instance</param>
        ...
        static GameObject GetPrefabRoot(Transform obj)
        {
            ...
            if (obj.parent == null || !PrefabUtility.IsPartOfAnyPrefab(obj.parent.gameObject))
            {
